...
playerColorButton = pygame.Rect((250, 250, 300, 50))
...
collisions = []
for _ in range(16):
    block = pygame.Rect(random.randint(0,800), random.randint(0,600), 50, 50)
...
while run:
    ...
    if current_menu == "mainMenu":
        ...
        text_surface = font.render("MenuCraft", True, (255, 255, 255))
        ...
        pygame.draw.rect(screen, BCCOL, playerColorButton)
        ...
        text_rect = text_surface.get_rect(center=playerColorButton.center)
        screen.blit(text_surface, text_rect)
