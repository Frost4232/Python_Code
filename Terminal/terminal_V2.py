    ...
    if cdSSD == "cd ssd":
        ...
        if folder_name in cdOptions:
            if folder_name == str(folderSelection1):
                ...
                if cdItems in itemCdOptions1 and "cd crypto" == folderItems1:
                    print("Crypto Found!!!")
                    cryptoUnfound = 0
                    print("\nYou Win!")
                elif cdItems in itemCdOptions1 and "cd crypto" != folderItems1:
                ...
                if cdItems in itemCdOptions2 and "cd crypto" == folderItems2:
                    print("Crypto Found!!!")
                    cryptoUnfound = 0
                    print("\nYou Win!")
                elif cdItems in itemCdOptions2 and "cd crypto" != folderItems2:
                    print("ERROR: NOT CRYPTO")
                    print(" ")
                else:
                    print("Failed: Not Found")
                ...
                if cdItems in itemCdOptions3 and "cd crypto" == folderItems3:
                    print("Crypto Found!!!")
                    cryptoUnfound = 0
                    print("\nYou Win!")
                elif cdItems in itemCdOptions3 and "cd crypto" != folderItems3:
                    print("ERROR: NOT CRYPTO")
                    print(" ")
                else:
                    print("Failed: Not Found")

            #cdItems = input("C:/Users/" + user + "/ssd" + "/folder" + "> ")
            #if cdItems in itemCdOptions and "cd crypto" == cdItems:
            #    print("Crypto Found!!!")
            #    cryptoUnfound = 0
            #    print("\nYou Win!")
            #elif cdItems in itemCdOptions and "cd crypto" != cdItems:
            #    print("ERROR: NOT CRYPTO")
            #    print(" ")
            #else:
            #    print("Failed: Not Found")
...
#        print(" ")
#        cdItems = input("C:/Users/" + user + "/ssd" + "/folder" + "> ")
#        if cdItems in itemCdOptions and "cd crypto" in itemCdOptions:
#            print("Crypto Found!!!")
#            cryptoUnfound = 0
#        elif cdItems in itemCdOptions and "cd crypto" not in itemCdOptions:
#            print("ERROR: NOT CRYPTO")
#        else:
#            print("Failed")