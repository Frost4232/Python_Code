...
while run:
    ...
    if current_menu == "mainMenu":
        ...
        pygame.draw.rect(screen, DSWCOL, difficultyWinButton)
        ...
        text_rect = text_surface.get_rect(center=difficultyWinButton.center)
        screen.blit(text_surface, text_rect)
        ...
        pygame.draw.rect(screen, DSLCOL, difficultyLoseButton)
        ...
        text_surface = font.render("Difficulty", True, (255, 255, 255))
        text_rect = text_surface.get_rect(center=difficultyLoseButton.center)
        screen.blit(text_surface, text_rect)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            if current_menu == "mainMenu":
                ...
                if exitWinButton.collidepoint(pos):
                    run = False
                elif difficultyWinButton.collidepoint(pos):
                ...
                if exitLoseButton.collidepoint(pos):
                    run = False
                elif difficultyLoseButton.collidepoint(pos):
                    current_menu = "difficulty"
